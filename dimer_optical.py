...
def L_vib_lindblad(H_vib, A, eps, Gamma, T, J):
    '''
...
if __name__ == "__main__":
    ...
    L_RC, H_vib, A_1, A_2, A_EM, wRC_1, wRC_2 = RC.RC_mapping_UD(
                                ...
                                alpha_1, alpha_2, wc,  N_1, N_2, exc, mu=1, num_cpus=3)
    print "*******   L_RC  *******"
    ...
    # Secular version
    print "*******   L_S  *******"
    L_s = L_vib_lindblad(H_vib, A_EM, eps, Gamma_EM, T_EM, J_minimal)
