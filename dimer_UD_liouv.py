...
def dimer_ham_RC(w_1, w_2, w_xx, V, mu, Omega_1, Omega_2, kap_1, kap_2, N_1, N_2=False):
    """
    ...
    A_1 = tensor(I_dim, destroy(N_1).dag()+ destroy(N_1), I_RC_2)
    A_2 = tensor(I_dim, I_RC_1, destroy(N_2).dag()+ destroy(N_2))
